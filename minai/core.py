...
__all__ = ['def_device', 'Dataset', 'TfmDataset', 'get_dls', 'collate_dict', 'DataLoaders', 'show_image', 'subplots', 'get_grid',
           ...
           'MomentumLearner', 'DeviceCB', 'SingleBatchCB', 'MetricsCB', 'ProgressCB', 'CapturePreds', 'capture_preds',
           ...
           'get_hist', 'ActivationStats', 'summary', 'BatchTransformCB', 'GeneralRelu', 'rand_erase', 'RandErase',
           'rand_copy', 'RandCopy', 'clean_ipython_hist', 'clean_tb', 'clean_mem']
